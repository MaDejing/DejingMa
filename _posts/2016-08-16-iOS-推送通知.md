...
<img src="{{ site.baseurl}}/public/images/push/push04.png" style="margin-bottom: 0;" />
<p>3. 请求成功时，系统会在应用程序委托方法中返回 DeviceToken，请求失败时，也会在对应的委托方法中给出请求失败的原因。</p>
<img src="{{ site.baseurl}}/public/images/push/push05.png" style="margin-bottom: 0;" />
...
<img src="{{ site.baseurl}}/public/images/push/push06.png" style="margin-bottom: 0;" />
<blockquote>
...
<img src="{{ site.baseurl}}/public/images/push/push07.png" style="margin-bottom: 0;" />
